...
@JsonIgnoreProperties(ignoreUnknown = true) // JSON ignoruje pola które nie należą do klasy. Dzięki czemu nie zwraca błędu. AppUesr podaje więcej pól niż ma klasa
